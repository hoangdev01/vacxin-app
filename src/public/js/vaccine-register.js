        ...
        $.ajax({
            ...
            success: function (response) {
                if (response != "") {
                    ...
                    $("#for-vaccine-code").text(
                        "Nhập mã đơn tiêm chủng đã được gửi đến cho bạn"
                    );
                    ...
                    $("#for-vaccine-code").text(
                        "Mã đơn tiêm chủng không tồn tại, vui lòng nhập lại"
                    );
...
function getError(value) {
    ...
    if (value == "#help-email-customer") {
        return "Vui lòng nhập email người đăng ký đơn tiêm chủng";
    }
}
//show error
